                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-12">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input name="name" class="form-control" id="inputFirstName" type="text" placeholder="Enter your user name" />
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            ...
                            <div>
                                <a href="{{ asset('backend') }}/#">Privacy Policy</a>
                                &middot;
                                <a href="{{ asset('backend') }}/#">Terms &amp; Conditions</a>
                            </div>
                        </div>
                    </div>
                </footer>
